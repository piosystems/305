...
pub fn run2() {
    ...
    let _rectangle4: Rect = "4,5,Rectangle3".into(); //same effect as above

    let rectangle5 = rectangle1.clone();

    assert_eq!(rectangle1, rectangle5);
    println!("If you can see this, your two triangles {} and {} are equal", &rectangle1.name, &rectangle3.name);

    //Get part of one rectangle for another
    let _rectangle6 = Rect {
        length: 12i32,
        ..rectangle1
    };
